...
# `deprecated_aliases` map ({old_name: new_snake_case}) directly in NITRO_RESOURCE_MAP
# ModuleExecutor reads it to keep old playbooks working (pre-parse translation + deprecation warning) and to restore
