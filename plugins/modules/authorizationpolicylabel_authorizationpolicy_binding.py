...
DOCUMENTATION = r"""
module: authorizationpolicylabel_authorizationpolicy_binding
short_description: Binding Resource definition for describing association between
  authorizationpolicylabel and authorizationpolicy resources
description: Binding Resource definition for describing association between authorizationpolicylabel
  ...
  invoke:
    ...
    description:
      - If the current policy evaluates to TRUE, terminate evaluation of policies
        bound to the current policy label, and then either forward the request or
        response to the specified virtual server or evaluate the specified policy
        label.
  invoke_labelname:
    type: str
    description:
