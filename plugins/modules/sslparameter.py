...
options:
  ...
  ndcppcompliancecertcheck:
    ...
    choices:
      ...
      - 'NO'
    description:
      - Determines whether or not additional checks are carried out during a TLS handshake
        when validating an X.509 certificate received from the peer.
      - 'Settings apply as follows:'
      - C(YES) - (1) During certificate verification, ignore the
      ...
      - C(NO)  - (1) Verify the Common Name field (inside the subject name)
