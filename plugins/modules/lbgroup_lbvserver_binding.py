...
DOCUMENTATION = r"""
module: lbgroup_lbvserver_binding
short_description: Binding Resource definition for describing association between
  lbgroup and lbvserver resources
description: Binding Resource definition for describing association between lbgroup
  and lbvserver resources
version_added: 2.0.0
author:
  ...
  name:
    ...
    description:
      - Name for the load balancing virtual server group. Must begin with an ASCII
        ...
        hyphen (-) characters. Can be changed after the virtual server is created.
      - ''
