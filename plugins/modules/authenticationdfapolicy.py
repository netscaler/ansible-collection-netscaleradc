...
DOCUMENTATION = r"""
---
module: authenticationdfapolicy
short_description: Configuration for Dfa authentication policy resource.
description: Configuration for Dfa authentication policy resource.
version_added: 2.0.0
author:
