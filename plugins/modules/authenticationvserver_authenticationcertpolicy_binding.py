...
DOCUMENTATION = r"""
---
module: authenticationvserver_authenticationcertpolicy_binding
short_description: Binding Resource definition for describing association between
  authenticationvserver and authenticationcertpolicy resources
description: Binding Resource definition for describing association between authenticationvserver
  and authenticationcertpolicy resources
version_added: 2.0.0
author:
