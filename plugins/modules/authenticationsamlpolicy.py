...
DOCUMENTATION = r"""
module: authenticationsamlpolicy
short_description: Configuration for AAA Saml policy resource.
description: Configuration for AAA Saml policy resource.
version_added: 2.0.0
author:
  ...
  rule:
    description:
      - Name of the Citrix ADC named rule, or an expression, that the policy uses
        to determine whether to attempt to authenticate the user with the SAML server.
    type: str
