...
DOCUMENTATION = r"""
---
module: sslpolicylabel
short_description: Configuration for SSL policy label resource.
description: Configuration for SSL policy label resource.
version_added: 2.0.0
author:
  ...
  labelname:
    ...
    description:
      - Name for the SSL policy label.  Must begin with an ASCII alphanumeric or underscore
        ...
        Cannot be changed after the policy label is created.
      - ''
