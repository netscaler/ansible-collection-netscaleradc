...
DOCUMENTATION = r"""
module: contentinspectionparameter
short_description: Configuration for Contentinspection parameter resource.
description: Configuration for Contentinspection parameter resource.
version_added: 2.0.0
author:
