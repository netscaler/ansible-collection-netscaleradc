...
DOCUMENTATION = r"""
module: contentinspectionpolicylabel
short_description: Configuration for ContentInspection policy label resource.
description: Configuration for ContentInspection policy label resource.
version_added: 2.0.0
author:
  ...
  labelname:
    ...
    description:
      - Name for the contentInspection policy label. Must begin with a letter, number,
        ...
        (:), and underscore characters. Cannot be changed after the contentInspection
        policy label is added.
      - ''
