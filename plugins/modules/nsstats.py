...
DOCUMENTATION = r"""
module: nsstats
short_description: Configuration for stats resource.
description: Configuration for stats resource.
version_added: 2.0.0
author:
...
options:
  cleanuplevel:
    choices:
      ...
      - all
    description:
      - The level of stats to be cleared. 'C(global)' option will clear C(global)
