...
options:
  ...
  name:
    type: str
    description:
      - 'Name to assign to the imported spec file. Must begin with an ASCII alphanumeric
  ...
  src:
    type: str
    description:
      - URL specifying the protocol, host, and path, including file name, to the spec
        file to be imported. For example, http://www.example.com/spec_file.
