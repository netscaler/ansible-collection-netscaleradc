...
DOCUMENTATION = r"""
---
module: cacheselector
short_description: Configuration for cache selector resource.
description: Configuration for cache selector resource.
version_added: 2.0.0
author:
...
options:
  ...
  selectorname:
    type: str
    description:
      - Name for the selector.  Must begin with an ASCII alphabetic or underscore
