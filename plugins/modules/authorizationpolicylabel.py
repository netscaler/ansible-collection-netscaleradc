...
DOCUMENTATION = r"""
module: authorizationpolicylabel
short_description: Configuration for authorization policy label resource.
description: Configuration for authorization policy label resource.
version_added: 2.0.0
author:
  ...
  labelname:
    description:
      ...
      - Must begin with a letter, number, or the underscore character (_), and must
        ...
        after the authorization policy is created.
      - ''
