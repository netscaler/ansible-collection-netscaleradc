...
DOCUMENTATION = r"""
---
module: appfwjsonerrorpage
short_description: Configuration for JSON error page resource.
description: Configuration for JSON error page resource.
version_added: 2.0.0
author:
  ...
  src:
    ...
    description:
      - URL (protocol, host, path, and name) for the location from which to fetch
        the imported JSON error object.
