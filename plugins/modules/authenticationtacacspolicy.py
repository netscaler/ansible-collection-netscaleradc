...
DOCUMENTATION = r"""
---
module: authenticationtacacspolicy
short_description: Configuration for TACACS policy resource.
description: Configuration for TACACS policy resource.
version_added: 2.0.0
author:
  ...
  name:
    ...
    description:
      ...
      - Must begin with a letter, number, or the underscore character (_), and must
        ...
        after TACACS+ policy is created.
      - ''
  ...
  rule:
    ...
    description:
      - Name of the Citrix ADC named rule, or an expression, that the policy uses
        to determine whether to attempt to authenticate the user with the TACACS+
        server.
