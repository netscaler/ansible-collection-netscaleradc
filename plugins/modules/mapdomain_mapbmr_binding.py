...
DOCUMENTATION = r"""
module: mapdomain_mapbmr_binding
short_description: Binding Resource definition for describing association between
  mapdomain and mapbmr resources
description: Binding Resource definition for describing association between mapdomain
  and mapbmr resources
version_added: 2.0.0
author:
  ...
  name:
    ...
    description:
      - 'Name for the MAP Domain. Must begin with an ASCII alphanumeric or underscore
        ...
        Cannot be changed after the  MAP Domain is created . The following requirement
