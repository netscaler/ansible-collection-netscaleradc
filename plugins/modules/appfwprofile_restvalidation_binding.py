...
DOCUMENTATION = r"""
---
module: appfwprofile_restvalidation_binding
short_description: Binding Resource definition for describing association between
  appfwprofile and restvalidation resources
description: Binding Resource definition for describing association between appfwprofile
  and restvalidation resources
version_added: 2.0.0
author:
...
options:
  ...
  restvalidation:
    type: str
    description:
      - 'Exempt REST endpoints or any other URLs matching the given pattern from the
        API schema validation check. Example: GET:/v1/bookstore/viewbooks'
  ruletype:
    type: str
    choices:
      - ALLOW
