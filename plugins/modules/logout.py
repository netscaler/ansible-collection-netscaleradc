...
DOCUMENTATION = r"""
module: logout
short_description: Logout from a NetScaler ADC node.
description: Configuration for logging out from a NetScaler ADC node.
version_added: 2.0.0
author:
...
RETURN = r"""
changed:
    description: Indicates if any change is made by the module. `logout` module always returns `true` unless it fails.
    returned: always
    type: bool
    sample: true
failed:
