...
DOCUMENTATION = r"""
---
module: sslcacertgroup
short_description: Configuration for Group of CA certificate-key pairs resource.
description: Configuration for Group of CA certificate-key pairs resource.
version_added: 2.0.0
author:
