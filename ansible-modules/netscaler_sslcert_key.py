...
DOCUMENTATION = '''
---
module: netscaler_sslcert_key
short_description: Manage ssl certificate key configuration in Netscaler
description:
    - Manage ssl certificate key configuration in Netscaler
