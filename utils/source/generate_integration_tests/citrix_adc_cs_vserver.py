...
ENTITY_NAME = 'citrix_adc_cs_vserver'
...
def get_testbed_data(test_type='citrix_adc_direct_calls', ns_version='12.1'):
    ...
    testbedObj = BaseIntegrationModule(test_type, 'citrix_adc_cs_policy')
    testbed_1 = OrderedDict(
        [
            ('policyname', 'policy-1'),
...
def get_input_data(test_type='citrix_adc_direct_calls', ns_version='12.1'):
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME, 'cs_vserver_default_lb')
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_dns')
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_flap_disabled')
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_http') 
    setup_data = OrderedDict(
        [
            ('name', 'cs-vserver-1'),
            ('servicetype', 'HTTP'),
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_ippattern')
    setup_data = OrderedDict(
        [
            ('name',  'cs-vserver-2'),
            ('servicetype',  'HTTP'),
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_mssql')
    setup_data = OrderedDict(
        [
            ('name',  'cs-vserver-4'),
            ('servicetype',  'MSSQL'),
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_mysql')
    setup_data = OrderedDict(
        [
            ('name',  'cs-vserver-5'),
            ('servicetype',  'MYSQL'),
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_oracle')
    setup_data = OrderedDict(
        [
            ('name',  'cs-vserver-3'),
            ('servicetype',  'ORACLE'),
    ...
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME,  'cs_vserver_policies')
    setup_data = OrderedDict(
        [
            ('name',  'cs-vserver-3'),
            ('servicetype',  'HTTP'),
    ...
    # Actual module
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME, 'cs_vserver_appfwpolicy_binding')
