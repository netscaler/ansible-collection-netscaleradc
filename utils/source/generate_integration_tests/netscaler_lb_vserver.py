...
testbedObj = BaseIntegrationModule('netscaler_server')
testbed = OrderedDict(
    [
        ('name', 'server-{{ item }}'),
...
testbedObj = BaseIntegrationModule('netscaler_service')
testbed = OrderedDict(
    [
...
testbedObj = BaseIntegrationModule('netscaler_servicegroup')
testbed = OrderedDict(
    [
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_any')
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_dns')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-8'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME,  'lb_vserver_flap_disabled')
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_http')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name','lb-vserver-1'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_iphash')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-10'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_ippattern')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-9'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_mssql')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-6'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_mysql')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-7'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_oracle')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-5'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_push')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-11'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_tcp')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-3'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_servicegroup')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-20'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_rtspnat')
setup_data = OrderedDict(
    [
        ('state','present'),
        ('name', 'lb-vserver-2'),
...
# Actual module
submodObj = BaseIntegrationModule(ENTITY_NAME, 'lb_vserver_appfwpolicy_binding')
