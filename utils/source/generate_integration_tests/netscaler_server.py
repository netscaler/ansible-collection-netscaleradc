...
def get_input_data(test_type='netscaler_direct_calls', ns_version='12.1'):
    ...
    # For Submodule 'netscaler_server'
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME, 'netscaler_server')
    ...
    # For Submodule 'netscaler_server_domain'
    submodObj = None
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME, 'netscaler_server_domain')
    setup_data = OrderedDict(
        [
            ('name', 'test-server-2'),
            ('state', 'present'),
    ...
    # For Submodule 'netscaler_server_ipv6'
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME, 'netscaler_server_ipv6')
    setup_data = OrderedDict(
        [
            ('name', 'test-server-2'),
            ('state', 'present'),
