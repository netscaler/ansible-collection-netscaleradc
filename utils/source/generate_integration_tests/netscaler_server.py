...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'netscaler_server')
...
submodObj = None
submodObj = BaseIntegrationModule(ENTITY_NAME, 'netscaler_server_domain')
setup_data = OrderedDict(
    [
        ('name', 'test-server-2'),
        ('state', 'present'),
...
submodObj = BaseIntegrationModule(ENTITY_NAME, 'netscaler_server_ipv6')
setup_data = OrderedDict(
    [
        ('name', 'test-server-2'),
        ('state', 'present'),
