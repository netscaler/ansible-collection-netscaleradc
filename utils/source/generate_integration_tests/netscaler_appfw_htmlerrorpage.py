...
ENTITY_NAME = 'netscaler_appfw_htmlerrorpage'
...
def get_input_data(test_type='netscaler_direct_calls', ns_version='12.1'):
    ...
    # For Submodule 'netscaler_appfw_htmlerrorpage'
    submodObj = BaseIntegrationModule(test_type, ENTITY_NAME, 'netscaler_appfw_htmlerrorpage')
