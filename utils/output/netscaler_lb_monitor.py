...
options:
    ...
    monitorname:
        description:
            - >-
                Name for the monitor. Must begin with an ASCII alphanumeric or underscore (_) character, and must
            ...
            - >-
                ...
                marks (for example, "my monitor" or 'my monitor').
            - "Minimum length = 1"
    ...
    action:
        ...
        description:
            - >-
                Action to perform when the response to an inline monitor (a monitor of type HTTP-INLINE) indicates
                that the service is down. A service monitored by an inline monitor is considered DOWN if the response
                code is not one of the codes that have been specified for the Response Code parameter.
            - "Available settings function as follows:"
            - >-
                * NONE - Do not take any action. However, the show service command and the show lb monitor command
            ...
            - >-
                * DOWN - Mark the service as being down, and then do not direct any traffic to the service until the
    ...
    respcode:
        description:
            - >-
                ...
                depends on the monitor type. HTTP monitors and RADIUS monitors mark the service as DOWN, while
    ...
    sipuri:
        description:
            - >-
                SIP URI string to send to the service (for example, sip:sip.test). Applicable only to monitors of
                type SIP-UDP.
            - "Minimum length = 1"
    ...
    sipreguri:
        description:
            - >-
                SIP user to be registered. Applicable only if the monitor is of type SIP-UDP and the SIP Method
                parameter is set to REGISTER.
            - "Minimum length = 1"
    ...
    recv:
        description:
            - >-
                String expected from the server for the service to be marked as UP. Applicable to TCP-ECV, HTTP-ECV,
                and UDP-ECV monitors.
    ...
    username:
        description:
            - >-
                User name with which to probe the RADIUS, NNTP, FTP, FTP-EXTENDED, MYSQL, MSSQL, POP3, CITRIX-AG,
                CITRIX-XD-DDC, CITRIX-WI-EXTENDED, CITRIX-XNC or CITRIX-XDM server.
            - "Minimum length = 1"

    password:
        description:
            - >-
                Password that is required for logging on to the RADIUS, NNTP, FTP, FTP-EXTENDED, MYSQL, MSSQL, POP3,
                CITRIX-AG, CITRIX-XD-DDC, CITRIX-WI-EXTENDED, CITRIX-XNC-ECV or CITRIX-XDM server. Used in
                conjunction with the user name specified for the User Name parameter.
            - "Minimum length = 1"
    ...
    logonpointname:
        description:
            - >-
                ...
                CITRIX-AAC-LAS and CITRIX-AAC-LOGINPAGE monitors.

    lasversion:
        description:
            - >-
                Version number of the Citrix Advanced Access Control Logon Agent. Required by the CITRIX-AAC-LAS
                monitor.
    ...
    radkey:
        description:
            - >-
                ...
                to monitors of type RADIUS and RADIUS_ACCOUNTING.
            - "Minimum length = 1"
    ...
    radnasip:
        description:
            - >-
                ...
                server. Applicable to monitors of type RADIUS and RADIUS_ACCOUNTING.
    ...
    resptimeout:
        description:
            ...
            - >-
                Note: For UDP-ECV monitors for which a receive string is not configured, response timeout does not
                apply. For UDP-ECV monitors with no receive string, probe failure is indicated by an ICMP port
    ...
    destport:
        description:
            - >-
                ...
                service to which the monitor is bound is considered the destination port. For a monitor of type USER,
                however, the destination port is the port number that is included in the HTTP request sent to the
                dispatcher. Does not apply to monitors of type PING.
    ...
    domain:
        description:
            - >-
                ...
                present. Required by CITRIX-XD-DDC and CITRIX-WI-EXTENDED monitors for logging on to the DDC servers
    ...
    ipaddress:
        description:
            - >-
                ...
                or AAAA. Applicable to DNS monitors.
            - "Minimum length = 1"
    ...
    filename:
        description:
            - >-
                ...
                existence of the file on the server. Applicable to FTP-EXTENDED monitors.
            - "Minimum length = 1"
    ...
    basedn:
        description:
            - >-
                ...
                the attributes in the monitoring query. Required for LDAP service monitoring.
            - "Minimum length = 1"
    ...
    binddn:
        description:
            - >-
                ...
                Optional. Applicable to LDAP monitors.
            - "Minimum length = 1"
    ...
    sqlquery:
        description:
            - >-
                SQL query for a MYSQL-ECV or MSSQL-ECV monitor. Sent to the database server after the server
    ...
    evalrule:
        description:
            ...
            - >-
                ...
                server, use the rule MYSQL.RES.ROW(10) .TEXT_ELEM(2).EQ("MySQL").
    ...
    sitepath:
        description:
            - >-
                URL of the logon page. For monitors of type CITRIX-WEB-INTERFACE, to monitor a dynamic page under the
                site path, terminate the site path with a slash (/). Applicable to CITRIX-WEB-INTERFACE,
                CITRIX-WI-EXTENDED and CITRIX-XDM monitors.
            - "Minimum length = 1"

    storename:
        description:
            - >-
                Store Name. For monitors of type STOREFRONT, STORENAME is an optional argument defining storefront
                service store name. Applicable to STOREFRONT monitors.
            - "Minimum length = 1"
    ...
    metric:
        description:
            - >-
                Metric name in the metric table, whose setting is changed. A value zero disables the metric and it
                will not be used for load calculation.
            - "Minimum length = 1"
            - "Maximum length = 37"
