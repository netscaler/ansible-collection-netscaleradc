            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <br/><div style="font-size: small; color: red">list</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Groups to which this role is assigned.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Id is system generated key for all the RBA roles.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <br/><div style="font-size: small; color: red">list</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Policies attached to this role..</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <br/><div style="font-size: small; color: red">list</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Resourcegroups attached to this role..</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>success</td>
                <td>
                                            <div>Dictionary contatining the attributes of the created rba_role.</div>
                                        <br/>
                                    </td>
            </tr>
                        </table>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/citrix_adm_rba_role.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
