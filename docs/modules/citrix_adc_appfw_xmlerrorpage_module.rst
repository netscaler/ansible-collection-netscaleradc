:source: citrix_adc_appfw_xmlerrorpage.py
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Any comments to preserve information about the XML error object.</div>
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Indicates name of the imported xml error page to be removed.</div>
                    ...
                    <br/><div style="font-size: small; color: red">bool</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Overwrite any existing XML error object of the same name.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>URL (protocol, host, path, and name) for the location at which to store the imported XML error</div>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/citrix_adc_appfw_xmlerrorpage.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
