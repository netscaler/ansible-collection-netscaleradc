:source: citrix_adm_dns_domain_entry.py

:orphan:

.. _citrix_adm_dns_domain_entry_module:
...
Synopsis
--------
- Manage Citrix ADM domain names.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Description of DNS Domain Entry.</div>
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Id is system generated key for all the DNS Domain Entries.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Tenant Id of the DNS Domain Entries.</div>
                                                    <div>Minimum length = 1</div>
                                                    <div>Maximum length = 128</div>
                                                                                </td>
            </tr>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="1">
                    <b>dns_domain_entry</b>
                    <br/><div style="font-size: small; color: red">dict</div>
                                    </td>
                <td>success</td>
                <td>
                                            <div>The created dns domain entry object.</div>
                                        <br/>
                                    </td>
            </tr>
                                <tr>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/citrix_adm_dns_domain_entry.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
