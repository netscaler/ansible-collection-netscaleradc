:source: citrix_adm_ns_facts.py

:orphan:

.. _citrix_adm_ns_facts_module:
...
Synopsis
--------
- Retrieve facts about Citrix ADM managed instances.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Id is system generated key for all the managed devices.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>IP Address for this managed device.</div>
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of managed device.</div>
                                                    <div>Minimum length = 1</div>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>success</td>
                <td>
                                            <div>List containing the details of the requested ns instances</div>
                                        <br/>
                                    </td>
            </tr>
                        </table>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/citrix_adm_ns_facts.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
