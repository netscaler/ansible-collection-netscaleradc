:source: citrix_adm_tenant_facts.py
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <br/><div style="font-size: small; color: red">str</div>                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of the Tenant.</div>
                                                    <div>Minimum length = 1</div>
                                                    <div>Maximum length = 512</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>success</td>
                <td>
                                            <div>List containing the details of the requested tenants.</div>
                                        <br/>
                                    </td>
            </tr>
                        </table>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/citrix_adm_tenant_facts.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
